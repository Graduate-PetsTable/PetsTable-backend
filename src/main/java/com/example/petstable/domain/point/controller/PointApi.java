...
public interface PointApi {
    ...
    PetsTableApiResponse<PointMyBalanceResponse> getMyPoint(@Parameter(hidden = true) @LoginUserId Long memberId);

    @Operation(summary = "포인트 내역 조회 API", description = "나의 포인트를 거래 내역을 조회합니다",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            content = @Content(
                                    ...
                                    examples = @ExampleObject(value = """
                                        [
                                          ...
                                          },
                                          {
                                            ...
                                            "transactionType": "차감",
                                            "description": "레시피 삭제",
                                            "createTime": "2024-10-26 10:15:00"
                                          }
                                        ]
                                        """)
                            ),
    ...
    PetsTableApiResponse<List<PointResponse>> getMyPointHistory(@Parameter(hidden = true) @LoginUserId Long memberId);
}
