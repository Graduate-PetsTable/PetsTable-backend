...
public interface BookmarkRepository extends JpaRepository<BookmarkEntity, Long> {
    ...
    @Query("SELECT b FROM BookmarkEntity b JOIN FETCH b.member JOIN FETCH b.post WHERE b.member.id = :memberId AND b.post.id = :postId")
    Optional<BookmarkEntity> findByMemberIdAndPostIdWithMemberAndPost(@Param("memberId") Long memberId, @Param("postId") Long postId);
